      ...
      <header className="bg-slate-100 dark:bg-slate-900 dark:text-sky-100 p-1 z-20 top-0 md:sticky">
                    <div className="container flex justify-between mx-auto">
                        ...
                        <ul className="items-stretch hidden space-x-3 md:flex">
                            <li className="flex">
                                <a rel="noopener noreferrer" href="#about" className="flex items-center px-4 -mb-1 hover:text-sky-800  dark:border-transparent">User</a>
                            </li>
                            <li className="flex">
                                <a rel="noopener noreferrer" href="#projects" className="flex items-center px-4 -mb-1 hover:text-sky-800  dark:border-transparent">About</a>
                            </li>
                            <li className="flex">
                                <a rel="noopener noreferrer" href="#skills" className="flex items-center px-4 -mb-1 hover:text-sky-800  dark:border-transparent">Help</a>
                            </li>
                            <li className="flex">
                                <a rel="noopener noreferrer" href="#contact" className="flex items-center px-4 -mb-1 hover:text-sky-800  dark:border-transparent">Contact Us</a>
                            </li>
                        </ul>
